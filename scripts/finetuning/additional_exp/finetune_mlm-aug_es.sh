...
python run_finetuning.py \
  ...
  experiment_name=zero_shot_mlm-aug_es_${lang}_${seed} \
  seed=${seed} \
  use_wandb=True \
  ...
  log_directory=/projects/abeb4417/americasnli/logs/mlm-aug_es/ \
  output_directory=/rc_scratch/abeb4417/americasnli/mlm-aug_es/
