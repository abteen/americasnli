...
python run_finetuning.py \
  ...
  experiment_name=translate_train_mlm_${lang}_${seed} \
  seed=${seed} \
  use_wandb=True \
  log_directory=/projects/abeb4417/americasnli/logs/translate_train_mlm/ \
  output_directory=/rc_scratch/abeb4417/americasnli/translate_train_mlm/ \
